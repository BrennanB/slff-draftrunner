def new_draft(start_date, start_time, close_date, close_time, team_list, short_name):
    ...
    new_draft = "Draft will be run on [date={} time={} timezone=\"America/Toronto\"] . " \
            ...
            "Like this post to sign up, and send all the lists to my beautiful bot self! Make the title of your PM '{}'".format(start_date, start_time, close_date, close_time, team_list, short_name)
    return new_draft